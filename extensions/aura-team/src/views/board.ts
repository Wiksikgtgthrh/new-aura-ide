...
export class BoardPanel {
	...
	async show(board: BoardSnapshot): Promise<void> {
		if (!this.panel) {
			this.panel = vscode.window.createWebviewPanel('auraTeam.board', vscode.l10n.t('Team Board'), vscode.ViewColumn.One, { enableScripts: true });
